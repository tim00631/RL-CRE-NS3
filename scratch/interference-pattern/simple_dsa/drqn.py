...
class QNetwork:
    def __init__(self, learning_rate=0.01, state_size=4, 
        ...
        with tf.compat.v1.variable_scope(name):
            ...
            self.h2 = tensorflow.keras.layers.LayerNormalization()(self.h2)
            ...
            self.fc1 = tf.keras.layers.Dense(hidden_size, input_shape=(step_size, state_size))(self.inputs_)
            self.fc2 = tf.keras.layers.Dense(hidden_size, activation=tf.nn.relu)(self.fc1)
